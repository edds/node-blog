...
exports.Connection = function (database, username, password, port) {
  ...
  events.addListener('ErrorResponse', function (e) {
    ...
    if(typeof query_errback === "function") {
      query_errback.call(this, e.C, e.M);
    }
  });
  ...
  this.query = function (sql, callback, errback) {
    query_queue.push({sql: sql, callback: callback, errback: errback});
    if (readyState) {
